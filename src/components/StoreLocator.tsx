  ...
  return (
    <>
      <div className="relative flex h-[calc(100vh-210px)] flex-col border md:flex-row ">
        ...
        <div className="flex w-full flex-col overflow-y-auto md:w-1/3 m-2">
          <FilterSearch
            onSelect={handleFilterSelect}
            placeholder="Search by Address, City and State, or Zip"
            customCssClasses={{
              inputElement: "p-8 pl-1 text-lg border-black",
            }}
            searchFields={[
              {
                entityType: "location",
        ...
        <div className="relative h-[calc(100vh-310px)] w-full md:h-full md:w-2/3">
          <MapboxMap
            mapboxAccessToken={
              import.meta.env.YEXT_PUBLIC_MAPBOX_API_KEY ||
